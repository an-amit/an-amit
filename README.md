...
I am a results-driven **Software Developer** specializing in building scalable web applications and multi-tenant architectures. With a strong foundation in both **JavaScript** and **PHP** ecosystems, I bridge the gap between robust backend logic and seamless frontend experiences.

- 🔭 **Currently:** Leveling up as a Freelancer and exploring Generative AI.
- ⚡ **Focus:** High-performance e-commerce solutions and system design.
- 👨‍💻 **Portfolio:** [Check out my work here](https://portfolio-amit-dev.vercel.app/)
- 🌱 **Learning:** Deepening my knowledge in AI/ML and Advanced DSA.
